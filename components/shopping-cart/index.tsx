    ...
    <section className="cart">
      <div className="container">
        ...
        <div className="cart-actions">
          <a href="/products" className="cart__btn-back"><i className="icon-left"></i> Tiếp tục mua hàng</a>
          {/* <input type="text" placeholder="Promo Code" className="cart__promo-code" /> */}

          <div className="cart-actions__items-wrapper">
            <p className="cart-actions__total">Tổng tiền <strong>{priceTotal().toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')} VNĐ</strong></p>
